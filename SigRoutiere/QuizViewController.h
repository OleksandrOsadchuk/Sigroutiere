...
#define tanger [UIColor colorWithRed:1.0 green:128.0/255.0 blue:40.0/255.0 alpha:1.0]
...
//- (void)processAlertView:(UIAlertView *)alertView didDismissWithButtonIndex:(NSInteger)buttonIndex;
